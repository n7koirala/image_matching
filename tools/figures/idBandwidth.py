...
ax.plot(network, dfId["Blind-Match"].values, marker='*', linestyle='-', label='Blind-Match')
...
ax.set_title("Identification Scenario End-to-End Overhead\nover $2^{15}$ Database Subjects", fontsize=18)
...
# Save as PDF
pdf_filename = "identificationBandwidthLarge.pdf"
